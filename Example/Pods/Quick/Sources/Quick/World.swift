...
final internal class World: NSObject {
    ...
    */
    ...
    @objc public static let sharedWorld = World()
    ...
    */
    @objc internal func finalizeConfiguration() {
    ...
    */
    @objc internal func rootExampleGroupForSpecClass(_ cls: AnyClass) -> ExampleGroup {
    ...
    */
    ...
    @objc internal func registerSharedExample(_ name: String, closure: @escaping SharedExampleClosure) {
        raiseIfSharedExampleAlreadyRegistered(name)
        sharedExamples[name] = closure
    }

    @objc internal func sharedExample(_ name: String) -> SharedExampleClosure {
        raiseIfSharedExampleNotRegistered(name)
        return sharedExamples[name]!
    }

    @objc internal var includedExampleCount: Int {
        return includedExamples.count
    }

    @objc internal var beforesCurrentlyExecuting: Bool {
    ...
    @objc internal var aftersCurrentlyExecuting: Bool {
    ...
    @objc internal func performWithCurrentExampleGroup(_ group: ExampleGroup, closure: () -> Void) {
